        ...
        <div className="form-container">
          <form className="form" onSubmit={(e) => submitBusinessInformation(e)}>
            ...
            <div className="form-field">
              <label>
                Trading name/ Doing business as <span>*</span>
              </label>
            ...
            <div className="form-field">
              <label>
                Number of years in business <span>*</span>
              </label>
            ...
            <div className="form-field">
              <label>
                Types of product and services <span>*</span>
              </label>
              <input type="text" name="product_types_services" />
            </div>

            <div className="form-field">
              <label>
                URL / Website address <span>*</span>
              </label>
            ...
            <div className="form-field">
              <label>
                Target Market / Countries <span>*</span>
              </label>
            ...
            <div className="form-field">
              <label>
                Estimated Monthly Online Sales / Sales Forecast (Php){" "}
                <span>*</span>
              </label>
              <input type="number" name="estimated_sales" />
            </div>

            <div className="form-field">
              <label>
                Current Transaction Fee Charged (%) <span>*</span>
              </label>
            ...
            <div className="form-field">
              <label>
                Average Billing Amount <span>*</span>
              </label>
              <input type="number" name="average_billing_amount" />
            </div>

            <div className="form-field">
              <label>
                Highest Billing Amount <span>*</span>
              </label>
              <input type="number" name="highest_billing_amount" />
            </div>

            <div className="form-field">
              <label>
                Current Payment Gateway <span>*</span>
              </label>
              <input type="text" name="current_payment_gateway" />
            </div>

            <div className="form-field">
              <label>
                Familiar with chargeback? <span>*</span>
              </label>
