...
import {
  ...
  postFatca,
  postCustomerSupport,
} from "../../../../api/postAdditionalInformation";
        ...
        <div className="form-container">
          <form className="form" onSubmit={(e) => submitInformation(e)}>
            <div className="form-field">
              <label>
                List of Company/ies where you’re a
                Director/Officer/Stockholder/Authorized Signatory<span>*</span>
              </label>
              <input type="text" name="related_company_list" />
            </div>
            <div className="form-row">
              <div className="input-field">
                <label>
                  Bank Category<span>*</span>
                </label>
            ...
            <div className="form-row">
              ...
              <div className="input-field">
                ...
                <input type="tel" name="phone" placeholder="e.g 09XXXXXXXXX" />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="input-field">
                ...
                <input type="text" name="position" placeholder="e.g Owner" />
              </div>
              <div className="input-field">
                <label>
            ...
            <div className="form-row">
              ...
              <div className="input-field-short">
                ...
                <input type="text" name="us_zip_code" placeholder="e.g 1100" />
              </div>
            </div>

            <div className="form-field">
              <label>
                U.S Phone number <span>*</span>
              </label>
              <input
                type="tel"
                name="us_phone"
            ...
            <div className="form-field">
              <label>
                Length of stay in U.S <span>*</span>
              </label>
              <input
                type="number"
                name="length_of_stay"
            ...
            <div className="form-row">
              <div className="input-field">
                <label>
                  Customer Service Number<span>*</span>
                </label>
                <input
                  type="tel"
                  name="cs_number"
              ...
              <div className="input-field">
                <label>
                  Customer Service Schedule<span>*</span>
                </label>
                <input
                  type="text"
                  name="cs_schedule"
