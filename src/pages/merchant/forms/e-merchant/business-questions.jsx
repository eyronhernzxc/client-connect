  ...
  const submitBusinessQuestion = async (event) => {
    ...
    try {
      ...
      const business_information_id =
        user?.data?.business_information_id ||
        user?.data?.business_information?.id;
        ...
        <div className="form-container">
          <form className="form" onSubmit={(e) => submitBusinessQuestion(e)}>
            ...
            <div className="form-field">
              <label>
                Currently accepting Credit Card Payments? <span>*</span>
              </label>
              <div className="form-field-grid">
                <div className="radio-field">
                  <label>
                    {" "}
                    <input type="radio" value="yes" name="creditcard" />
                    Yes{" "}
                  </label>
                </div>
                ...
                <div className="radio-field">
                  <label>
                    <input type="radio" value="no" name="creditcard" />
                    No{" "}
                  </label>
                </div>
              </div>
            ...
            <div className="form-field">
              <label>
                Do you get proof of delivery? <span>*</span>
              </label>
              <div className="form-field-grid">
                <div className="radio-field">
                  <label>
                    {" "}
                    <input type="radio" value="yes" name="proof_of_delivery" />
                    Yes{" "}
                  </label>
                </div>
                ...
                <div className="radio-field">
                  <label>
                    <input type="radio" value="no" name="proof_of_delivery" />
                    No{" "}
                  </label>
                </div>
              </div>
            ...
            <div className="form-field">
              <label>
                Do you have refund policy? <span>*</span>
              </label>
              <div className="form-field-grid">
                <div className="radio-field">
                  <label>
                    {" "}
                    <input type="radio" value="yes" name="refund_policy" />
                    Yes{" "}
                  </label>
                </div>
                ...
                <div className="radio-field">
                  <label>
                    <input type="radio" value="no" name="refund_policy" />
                    No{" "}
                  </label>
                </div>
              </div>
            ...
            <div className="form-field">
              <label>
                How long does customer wait before product is received? (No. of
                days) <span>*</span>
              </label>
              <input type="number" name="days_product_received" />
            </div>

            <div className="form-field">
              <label>
                Does company offer warranties, dues, subscriptions, memberships
                or other extended services? <span>*</span>
              </label>
              <div className="form-field-grid">
                <div className="radio-field">
                  <label>
            ...
            <div className="form-field">
              <label>
                Are you using any shopping cart? <span>*</span>
              </label>
              <div className="form-field-grid">
                <div className="radio-field">
                  <label>
                    {" "}
                    <input type="radio" value="yes" name="shopping_cart" />
                    Yes{" "}
                  </label>
                </div>
                ...
                <div className="radio-field">
                  <label>
                    <input type="radio" value="no" name="shopping_cart" />
                    No{" "}
                  </label>
                </div>
              </div>
            ...
            <div className="form-field">
              <label>
                Are you selling via Mobile App? <span>*</span>
              </label>
              <div className="form-field-grid">
                <div className="radio-field">
                  <label>
                    {" "}
                    <input type="radio" value="yes" name="mobile_app_sale" />
                    Yes{" "}
                  </label>
                </div>
                ...
                <div className="radio-field">
                  <label>
                    <input type="radio" value="no" name="mobile_app_sale" />
                    No{" "}
                  </label>
                </div>
              </div>
